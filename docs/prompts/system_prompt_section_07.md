...
- 이미지 아래 간단한 설명 산문 1~2문장: 시계열 변화 방향성만 서술
  - **수치가 있는 경우**: "입원 시 BDI N점, 입원 N일차 기분 N점으로 호전/악화 양상"
  - **수치가 없는 경우**: "면담 기록에서 구체적 기분 수치 미확인. 호전/악화/유지 방향성은 환자 진술 기반으로 기술."
